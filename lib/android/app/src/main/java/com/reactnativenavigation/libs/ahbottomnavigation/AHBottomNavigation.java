package com.reactnativenavigation.libs.ahbottomnavigation;
...
import static com.reactnativenavigation.libs.ahbottomnavigation.AHHelper.fill;
import static com.reactnativenavigation.libs.ahbottomnavigation.AHHelper.map;
	...
	private void createClassicItems(LinearLayout linearLayout) {
		...
		for (int i = 0; i < items.size(); i++) {
			...
			if (itemsEnabledStates[i]) {
				...
				icon.setImageDrawable(current ? items.get(i).getSelectedDrawable(context):items.get(i).getDrawable(context));
